    ...
    <nav className={styles.navbar}>
      <NavLink to="/" className={styles.navItem} activeClassName={styles.activeNavItem}>
        <div className={styles.leftSide}>
          <img src={process.env.PUBLIC_URL + "/logo.svg"} alt="Shelter Logo" className={styles.logo} />
          <p>Shelter</p>
        </div>
      </NavLink>
      <div className={styles.rightSide}>
        <NavLink to="/" className={styles.navItem} activeClassName={styles.activeNavItem}>Home</NavLink>
